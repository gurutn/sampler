...
echo "$value"'''
        copyArtifacts(projectName: 'test job', target: 'C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\sampler_main', fingerprintArtifacts: true, filter: 'software/Installers/Q-Sys%20Designer/Release/Web/')
      }
    }
